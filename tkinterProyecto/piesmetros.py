...
pies_input.focus() #Enfoca direcamente al entrar a la app el campo de texto
root.bind("<Return>", calcular) #Permite escuchar eventos, donde se encuentre si preciona enter llama la función.
root.mainloop()
